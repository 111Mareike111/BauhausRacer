...
public class CreateWheelCollider : MonoBehaviour {

	// Method was used for creating new WheelColliders on Editor.
	public static WheelCollider CreateWheelCollider_ (GameObject car, Transform wheel){
		...
		wheelcollider.AddComponent<Wheel>();
